...
import { Code, FunctionOptions, IVersion, Runtime, Version } from "aws-cdk-lib/aws-lambda";
...
class EdgeLambdaFunction extends Construct {
    ...
    constructor(scope: Construct, id: string, options: EdgeLambdaFunctionOptions) {
        super(scope, id);

        this.edgeFunction = this.createEdgeFunction(id, options)
    }

    private createEdgeFunction(id: string, options: EdgeLambdaFunctionOptions): experimental.EdgeFunction {
        const command = [
            "sh",
            "-c",
...
export class RequestFunction extends EdgeLambdaFunction {
    constructor(scope: Construct, id: string, options: RequestFunctionOptions) {
        super(scope, id, {
            ...options, handlerName: 'origin-request', define: {
...
export class ResponseFunction extends EdgeLambdaFunction {
    constructor(scope: Construct, id: string, options: ResponseFunctionOptions) {
        super(scope, id, {
            ...options, handlerName: 'origin-response', define: {
